...
#### Цель работы:
Реализовать PID регулятор для модели нагрева из дредыдущей лабораторной.
  
---

#### Ход работы 
С помощью материалов из методеческого пособия и дополнительной информации реализовал PID функцию, 
подогнал параметры TD, K, T0 под себя. Запустил модель с PID регулятором, 
зафиксировал процесс на горфике зависимости моих значений от времени.
