...
1. К проекту [NIKA](https://github.com/ostis-apps/nika) был оформлен [вопрос](https://github.com/ostis-apps/nika/issues/170) о проблеме с запуском данного проекта на операционной системе Windows(приложен скриншот с получаемой ошибкой).
