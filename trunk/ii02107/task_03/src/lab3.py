                ...
                for id in data_ID_orient_line_X_Y:
                    if data_ID_orient_line_X_Y[id][0][2] == name_vanish_vertex or data_ID_orient_line_X_Y[id][1][2] == name_vanish_vertex:
                        canvas.create_line(*line_intersect_circle(data_ID_orient_line_X_Y[id][0][0], data_ID_orient_line_X_Y[id][0][1],\
                             data_ID_orient_line_X_Y[id][1][0], data_ID_orient_line_X_Y[id][1][1]), fill="white", width=2, arrow=tk.LAST)
        ...
        if ID_oriented_line !=0:
            for id in all_vanish_orline_id:
                if name_vanish_vertex == data_ID_orient_line_X_Y[id][0][2]:
                    ...
                    canvas.create_line(*line_intersect_circle(data_ID_orient_line_X_Y[id][0][0], data_ID_orient_line_X_Y[id][0][1],\
                         data_ID_orient_line_X_Y[id][1][0], data_ID_orient_line_X_Y[id][1][1]), fill=data_ID_orient_line_X_Y[id][0][3], width=2, arrow=tk.LAST)
                    ...
                    canvas.create_line(*line_intersect_circle(data_ID_orient_line_X_Y[id][0][0], data_ID_orient_line_X_Y[id][0][1],\
                         data_ID_orient_line_X_Y[id][1][0], data_ID_orient_line_X_Y[id][1][1]), fill=data_ID_orient_line_X_Y[id][1][3], width=2, arrow=tk.LAST)
            print("data_ID_orient_line_X_Y:\t",data_ID_orient_line_X_Y)
...
def algorithm(): # функция для создания окна с алгоритмами
    ...
    # canvas = tk.Canvas(new_application, bg="white", width=468, height=403) # Создание холста
    ...
    if UNORIN_ORIENT ==0:
        ...
        button_diametr_graph = tk.Button(new_application, text="Диаметр графа", command=lambda: diameterGraph(nodes,temp_edges),width=12, height=2, state=tk.DISABLED)
        button_radius_graph = tk.Button(new_application, text="Радиус графа", command=lambda: radiusGraph(nodes,temp_edges),width=12, height=2, state=tk.DISABLED)
        button_center_graph = tk.Button(new_application, text="Центр графа", command=lambda: centerGraph(nodes,temp_edges),width=12, height=2, state=tk.DISABLED)
...
def main():
    ...
    button_NEW_window = tk.Button(application, text="NEW window", command=NEW_window,width=15, height=2)
