                ...
                for name in data_id_unorient_line_x_y:
                    if data_id_unorient_line_x_y[name][0][2] == name_delete_vertex or data_id_unorient_line_x_y[name][1][2] == name_delete_vertex:
                        canvas.create_line(*line_intersect_circle(data_id_unorient_line_x_y[name][0][0], data_id_unorient_line_x_y[name][0][1],\
                             data_id_unorient_line_x_y[name][1][0], data_id_unorient_line_x_y[name][1][1]), fill="white", width=2)
    ...
    if mouse_y>0:
        ...
        if ID_none_oriented_line !=0:
            for id in all_vanish_nonorline_id:
                if name_vanish_vertex == data_id_unorient_line_x_y[id][0][2]:
                    data_id_unorient_line_x_y[id][0] = [mouse_x, mouse_y, name_vanish_vertex,data_id_unorient_line_x_y[id][0][3]]
                    canvas.create_line(*line_intersect_circle(data_id_unorient_line_x_y[id][0][0], data_id_unorient_line_x_y[id][0][1],\
                         data_id_unorient_line_x_y[id][1][0], data_id_unorient_line_x_y[id][1][1]), fill=data_id_unorient_line_x_y[id][0][3], width=2)
                elif name_vanish_vertex == data_id_unorient_line_x_y[id][1][2]:
                    data_id_unorient_line_x_y[id][1] = [mouse_x, mouse_y, name_vanish_vertex,data_id_unorient_line_x_y[id][1][3]]
                    canvas.create_line(*line_intersect_circle(data_id_unorient_line_x_y[id][0][0], data_id_unorient_line_x_y[id][0][1],\
                         data_id_unorient_line_x_y[id][1][0], data_id_unorient_line_x_y[id][1][1]), fill=data_id_unorient_line_x_y[id][1][3], width=2)
            print("data_id_unorient_line_x_y:\t",data_id_unorient_line_x_y)
        if ID_oriented_line !=0:
