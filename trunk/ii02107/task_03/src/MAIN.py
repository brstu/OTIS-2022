            ...
            for idj in all_vanish_orline_id:
                if name_vanish_vertex == data_id_orient_line_x_y[idj][0][2]:
                    ...
                    canvas.create_line(*line_intersect_circle(data_id_orient_line_x_y[idj][0][0], data_id_orient_line_x_y[idj][0][1],\
                         data_id_orient_line_x_y[idj][1][0], data_id_orient_line_x_y[idj][1][1]), fill=data_id_orient_line_x_y[idj][0][3], width=2, arrow=tk.LAST)
                    ...
                    canvas.create_line(*line_intersect_circle(data_id_orient_line_x_y[idj][0][0], data_id_orient_line_x_y[idj][0][1],\
                         data_id_orient_line_x_y[idj][1][0], data_id_orient_line_x_y[idj][1][1]), fill=data_id_orient_line_x_y[idj][1][3], width=2, arrow=tk.LAST)
            print("data_id_orient_line_x_y:\t",data_id_orient_line_x_y)
