...
# Выполнение задания #
В ходе работы с OSTIS-системой мной были найдены некоторые недочеты, о которых я сообщил в виде issues. Вот ссылка на них:
https://github.com/ostis-apps/nika/issues/181

NIKA не может ответить на вопросы:<br>
![image](images/2.png)
![image](images/1.png)

---
# Дополнение #
Помог участникам Хакатона, отсортировав фотографии по папкам [Dataset-For-Compare-Objects](https://github.com/SenchaBrest/Dataset-For-Compare-Objects/pull/10)